% fig_confidence_placeholder.tex
% PLACEHOLDER: Composite confidence score gamma vs Rf
% Curves: 3PH (solid blue), SLG (dashed red)
% Acceptance threshold gamma_min = 0.80
\begin{tikzpicture}
\begin{axis}[
  ...
  \node[draw,fill=white,rounded corners=2pt,inner sep=2pt,
    ...
    at (axis cs:140,0.92)
    {3PH: \textbf{93\%} / SLG: \textbf{100\%} acceptance ($\gamma\geq0.80$)};
