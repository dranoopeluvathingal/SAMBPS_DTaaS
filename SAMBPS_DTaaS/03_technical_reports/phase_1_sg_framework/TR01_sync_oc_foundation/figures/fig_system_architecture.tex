...
% ---- Gate annotation — right of conf node, clear of arrow label -------------
\node[font=\scriptsize, text=orange, anchor=west, right=4pt of conf]
      {$\gamma_{th}{=}0.70$};
...
% ---- Group labels outside boxes (avoid title collision) ---------------------
\node[font=\scriptsize\bfseries, text=genBlue!80!black,
      anchor=south west] at (physbox.north west)
      {Physical Plant \& Signal Chain};
\node[font=\scriptsize\bfseries, text=adaptPurp!80!black,
      anchor=north east] at (adaptbox.south east)
      {Inverse Estimation \& Adaptation};

% ---- Title — centred above entire figure ------------------------------------
\node[font=\small\bfseries, text=black!70,
      anchor=south, above=0.5cm of physbox.north]
