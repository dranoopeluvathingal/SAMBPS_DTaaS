...
\node[phase, fill=thesisorange!20, draw=thesisorange,
      minimum width=0.8cm, font=\tiny] at (0.3*0.42, 0.55) {Step 1\\EKF};

\node[phase, fill=thesisgray!20, draw=thesisgray,
      minimum width=1.2cm, font=\tiny] at (1.5*0.42, 0.55) {Step 2\\Settings};
...
%% Annotations
\node[font=\tiny, thesisorange] at (0.5*0.42, -0.7) {CUSUM\\alarm};
\node[font=\tiny, thesisgreen] at (28.5*0.042+0.5, -0.7) {All IEDs\\updated};
\node[font=\tiny, thesisred] at (31.0*0.042+0.5, -0.7) {GOOSE\\broadcast};
