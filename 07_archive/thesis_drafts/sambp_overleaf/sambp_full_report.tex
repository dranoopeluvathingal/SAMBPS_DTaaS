...
\begin{figure}[H]
\centering
\input{sambp_diagrams/inverse_estimation_diagram.tex}
...
\begin{figure}[H]
\centering
\input{sambp_diagrams/transformer_model_diagram.tex}
...
\RESULT{87T validation results: classification accuracy for all test scenarios}
...
\begin{figure}[H]
\centering
\input{sambp_diagrams/87l_fsm_diagram.tex}
...
\RESULT{87L validation results: performance under various channel conditions}
...
\RESULT{87B validation results: fault detection accuracy}
...
\RESULT{Integration test results: latency and reliability metrics}
