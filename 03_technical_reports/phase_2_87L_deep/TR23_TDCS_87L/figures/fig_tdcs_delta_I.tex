...
% ---- Value annotations -----------------------------------------------------
    ...
    \node[font=\tiny,blue!70!black,rotate=90] at (axis cs:2, 0.065) {0.055};
    \node[font=\tiny,blue!70!black,rotate=90] at (axis cs:3, 0.073) {0.063};
    \node[font=\tiny,blue!70!black,rotate=90] at (axis cs:4, 0.081) {0.071};
    \node[font=\tiny,blue!70!black,rotate=90] at (axis cs:5, 0.089) {0.079};
    \node[font=\tiny,blue!70!black,rotate=90] at (axis cs:6, 0.097) {0.087};
