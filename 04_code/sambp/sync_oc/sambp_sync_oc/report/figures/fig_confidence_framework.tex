...
\tikzset{
  ...
  out/.style  = {rectangle, rounded corners=3pt, draw=gC, fill=gC!10,
...
\node[draw=gray!40, fill=white, rounded corners=2pt, inner sep=5pt,
      align=left, font=\scriptsize, below=0.5cm of bh, xshift=-0.3cm]
{Reference values:\\
...
\node[draw=gC!50, fill=white, rounded corners=3pt, inner sep=6pt,
      align=center, font=\footnotesize, below=0.5cm of sum]
