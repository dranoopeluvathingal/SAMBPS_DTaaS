...
\node[proc2,  right=2.0cm of S7] (S8b)
...
% ---- Merge node + Step 9/10 -------------------------------------------------
\coordinate (merge) at ($(D1)+(0,-2.0)$);

\node[proc,   below=2.0cm of D1] (S9)
...
\draw[arr] (S8a.north) -- (S8b.south);

% ---- Merge to Step 9 --------------------------------------------------------
\draw[arr] (S8a.south) -- ++(0,-0.4) -- ($(S9.north east)+(0,0)$);
\draw[arr] (S8c.south) -- ++(0,-0.6) -| (S9.west);
\draw[arr] (S8b.south) -- ++(0,-0.4) -| (S9.east);
