...
model.  WP0.5 lands the $\pi$-derivation appendix
(\texttt{docs/AppendixA\_derivation.pdf}); WP2.1 lands the closed-form
distributed-parameter forward model
(\texttt{models/faultloc\_distributed\_param\_model.py}); WP2.2 lands
the closed-form analytic gradients
