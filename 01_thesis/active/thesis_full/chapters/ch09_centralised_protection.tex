...
\begin{itemize}
\item \textbf{PMU data:} 3 PMUs at buses 0, 4, 7 (Figure~\ref{fig:ch2_study_network})
...
in Table~\ref{tab:ch2_kibr_scenarios}.
...
by the MMS settings upload). Future work (Section~\ref{sec:ch10_gaps})
...
\begin{figure}[htbp]
  \centering
  \input{figures/ch9_closedloop_protocol.tex}
